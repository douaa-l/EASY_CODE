...
public class graphTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.graphtwo, container, false);
    }

    @Override
    public void onViewCreated(View view,@Nullable Bundle savedInsranceState ) {
        barChart=view.findViewById(R.id.mp_chart2);
        ...
        StringRequest stringRequest= new StringRequest(Request.Method.POST, URL_STAT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
               ...
               try {
                   ...
                   description.setText("evaluation des cours du niveau 2");
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("num_niv", String.valueOf(2));
